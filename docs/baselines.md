...
*创建：2026-08-12 · 更新：2026-08-18（追加 M5a 三课 90 题离线基线）*


## 基线 v2 — 2026-08-18（M5a，三课 90 题离线 BM25）
...
2. **M5a 退出条件 Recall@3 ≥ 0.8 全部达标**，与 M4 离线口径一致（OS 1.000、DS 0.929、CO 1.000）。
3. JSON 报告默认写到未跟踪的 `reports/`，只有确认后的数字才追加到本文档。
