...
| [`references/m8-active-execution-protocol-draft-0.11.md`](references/m8-active-execution-protocol-draft-0.11.md) | `draft-0.11` protocol blob | `DRAFTED / PENDING_INDEPENDENT_P0_REVIEW / UNBOUND`；只实施 A+B+C，不推进 gate |
