...
| [`references/m8-active-execution-protocol-draft-0.11-authorization-20260914.md`](references/m8-active-execution-protocol-draft-0.11-authorization-20260914.md) | `draft-0.11` 修订授权 | `AUTHORIZED_FOR_PROTOCOL_REVISION / NOT_A_GATE / NOT_EXECUTION_AUTHORIZED`；协议正文尚未创建，M8 仍阻断 |
