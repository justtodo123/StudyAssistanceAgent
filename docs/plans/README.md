...
| `m7-source-lifecycle-plan.md` | 阶段执行计划 | 基础设施范围 `ADMITTED / IN_PROGRESS`；Source Registry、manifest/parser、normalized document、source-local 合同与 Search/QA overlay 已落地；冻结 1k/3k 未通过，Network 不在 scope 内 |
