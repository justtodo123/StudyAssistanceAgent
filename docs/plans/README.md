...
`ADMITTED / IN_PROGRESS`，生产开工已授权且 Source Registry、manifest/parser、normalized document、source-local FULL/INCREMENTAL/delete/isolation、FTS5/offline 与 Search/QA overlay 已落地；冻结 1k/3k BGE 协议已通过；M8–M10 仍保持阻断，须另做 M7 阶段退出评估。最终状态以 [`docs/PLAN.md`](../PLAN.md) 为准。
