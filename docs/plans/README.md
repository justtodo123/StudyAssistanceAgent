...
- 当前阶段：M6a 的 crawler P0、八项决策、保护基线与负责人批准均已闭合，现为 `ADMITTED / COMPLETE`；M6a-1 至 M6a-4 已完成，状态为 `ADMITTED / COMPLETE`；M6b 尚未获准
...
M6a 已完成强制决策、前置证据和负责人批准，现为 `ADMITTED / COMPLETE`；M6a-1 至 M6a-4 已完成，状态为 `ADMITTED / COMPLETE`；其余阶段继续按统一准入政策保持阻断。
