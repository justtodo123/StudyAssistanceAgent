...
| [`references/m8-draft011-revision-proposal-20260914.md`](references/m8-draft011-revision-proposal-20260914.md) | `draft-0.11` successor 修订提案 | `PROPOSAL_ONLY / NOT_AN_AUTHORIZATION / NOT_A_REVISION`；尚无协议正文或授权，不推进任何 gate |
