...
| `m8-metadata-discovery-governance.md` | M8 Metadata Discovery 治理规范 | 离线 Builder/QA/独立审查边界；当前 intent 未唯一确定，`METADATA_DISCOVERY_INTENT_OWNER_SELECTION_REQUIRED` |
