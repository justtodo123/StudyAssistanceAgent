...
| [`references/m8-active-execution-protocol-draft-0.11.md`](references/m8-active-execution-protocol-draft-0.11.md) | `draft-0.11` protocol blob | `P0_ACCEPTED / P1_AUTHORIZED / UNBOUND`；全新 identity 已创建，P1 仅授权 identity，尚未完成 P2 |
...
| [`references/m8-draft011-p2-decision-materials-20260914.md`](references/m8-draft011-p2-decision-materials-20260914.md) | `draft-0.11` P2 owner 裁定材料 | 候选 binding 的 commit、摘要和边界已闭合；等待 owner 接受或拒绝 |
