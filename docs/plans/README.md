...
| [`references/m8-active-execution-protocol-draft-0.11.md`](references/m8-active-execution-protocol-draft-0.11.md) | `draft-0.11` protocol blob | `P2_AUTHORIZED / BINDING_FROZEN`；下一步为另一主体执行独立 P3，仍未授权建根或执行 |
