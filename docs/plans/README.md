...
- 进行中：M6a/M6b 通用学习 Agent harness（M6 已拆为协议先行 + Agent 核心，实现未开工）
...
| `m6a-harness-skeleton-plan.md` | 项目工程执行计划 | M6a 协议先行，未开工 |
| `m6b-agent-core-plan.md` | 项目工程执行计划 | M6b ReAct + 工具调用，未开工（前置：M6a） |
