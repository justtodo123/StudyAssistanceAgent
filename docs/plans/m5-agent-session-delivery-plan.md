...
M0 至 M4 完成时，项目已经具备 8 个 API 端点、60 篇课程条目、51 条面经和 90 道评测题，但当时能力仍以
独立 API、Skill 和测试代码为主要入口，尚未形成可持续使用的后端学习会话。以下缺口均为 **M5 开工前历史
基线**，已由后续 M5a–M5e 关闭：
...
M5 已收口：评测入口、学习会话、SQLite 恢复、工作台、离线 CI 与文档已对齐。
下一步是按 `docs/demo.md` 彩排，并用工作台真实复习；不新开功能里程碑。
