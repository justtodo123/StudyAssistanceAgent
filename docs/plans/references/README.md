...
| [`m8-active-execution-protocol-draft-0.11.md`](m8-active-execution-protocol-draft-0.11.md) | `draft-0.11` protocol blob（191290 bytes，纯 LF） | `DRAFTED / PENDING_INDEPENDENT_P0_REVIEW / UNBOUND / NOT_EXECUTION_AUTHORIZED`；SHA-256 `92e28958…d40d`；只实施 A+B+C，未创建 gate/artifact |
...
| [`m8-draft011-p0-materials-20260914.md`](m8-draft011-p0-materials-20260914.md) | `draft-0.11` P0 独立审查材料 | `MATERIALS_PREPARED / P0_PENDING_REVIEW / NOT_A_GATE`；指定 reviewer `justtodo123`，drafting party `ai-assistant`；不预置裁定 |
| [`m8-draft011-p0-reviewer-worksheet-20260914.md`](m8-draft011-p0-reviewer-worksheet-20260914.md) | `draft-0.11` P0 reviewer 工作单 | `REVIEW_WORKSHEET / NOT_A_GATE / VERDICT_BLANK`；裁定表留空，供独立 reviewer 填写 |
