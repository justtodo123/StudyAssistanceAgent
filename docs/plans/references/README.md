...
| [`m8-active-execution-protocol-draft-0.11.md`](m8-active-execution-protocol-draft-0.11.md) | `draft-0.11` protocol blob（191290 bytes，纯 LF） | `P0_ACCEPTED / P1_AUTHORIZED / UNBOUND / NOT_EXECUTION_AUTHORIZED`；SHA-256 `92e28958…d40d`；P1 仅授权全新 identity，不授权 P2 或执行 |
...
| [`m8-draft011-p2-decision-materials-20260914.md`](m8-draft011-p2-decision-materials-20260914.md) | `draft-0.11` P2 owner 裁定材料 | `P2_DECISION_MATERIALS_READY / OWNER_DECISION_REQUIRED`；给出精确 commit 与候选摘要，不预置 P2 结论 |
