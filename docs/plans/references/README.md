...
| [`m8-active-execution-protocol-draft-0.11.md`](m8-active-execution-protocol-draft-0.11.md) | `draft-0.11` protocol blob（191290 bytes，纯 LF） | `P2_AUTHORIZED / BINDING_FROZEN / NOT_EXECUTION_AUTHORIZED`；SHA-256 `92e28958…d40d`；下一门禁为独立 P3 |
...
| [`m8-draft011-p3-reviewer-designation-20260914.md`](m8-draft011-p3-reviewer-designation-20260914.md) | `draft-0.11` P3 reviewer 指定 | `external-reviewer-01`；`P3_REVIEWER_DESIGNATED / AUDIT_PENDING / NOT_A_GATE`；不预置审计结论 |
