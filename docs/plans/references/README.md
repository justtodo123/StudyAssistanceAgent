...
| [`m8-active-execution-protocol-draft-0.10.md`](m8-active-execution-protocol-draft-0.10.md) | `draft-0.10` 正文（186129 bytes，纯 LF） | `DRAFTED / PENDING_P0_REVIEW / UNBOUND / NOT_AUTHORIZED / NEVER_EXECUTED`；依授权记录落地 A1/B1/C2a/D1a 四项文本修订；**独立 P0 审查结论尚未产生**，不得 binding 或执行 |
