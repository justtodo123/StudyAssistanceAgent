...
| [`m8-draft011-revision-proposal-20260914.md`](m8-draft011-revision-proposal-20260914.md) | `draft-0.11` successor 修订提案（三项 P3 阻断） | `PROPOSAL_ONLY / NOT_AN_AUTHORIZATION / NOT_A_REVISION`；不创建或授权 `draft-0.11`，不推进任何 gate |
