...
| [`m8-active-execution-protocol-draft-0.10.md`](m8-active-execution-protocol-draft-0.10.md) | `draft-0.10` 正文（186129 bytes，纯 LF） | `P0_ACCEPTED / P1_AUTHORIZED / P2_AUTHORIZED / BINDING_FROZEN / NEVER_EXECUTED`；P2 绑定 C: 专用 parent 与仓库提交 `9e7e9f7…`；下一动作 `request-p3`，仍不得创建 experiment root、获取依赖或执行 |
