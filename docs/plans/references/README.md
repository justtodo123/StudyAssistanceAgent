...
| [`external-artifacts/m8-minimal-1k-v3-s1-network-acquisition-authority-20260918-r01.json`](external-artifacts/m8-minimal-1k-v3-s1-network-acquisition-authority-20260918-r01.json) | v3 S1 network-acquisition 来源与 runtime authority 候选 | 冻结 CPython 3.13.3、官方 PyPI host、写入边界、限额和 provenance 字段；observer 尚未实例化，不授权联网或下载 |
