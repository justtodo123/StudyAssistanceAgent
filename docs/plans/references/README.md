...
| [`m8-network-acquisition-cycle-independent-review-prompt-20260919-r04.md`](m8-network-acquisition-cycle-independent-review-prompt-20260919-r04.md) | Corrected independent scope-review prompt | Requires independent canonical/Git/policy verification and limits the Reviewer to three fail-closed decisions |
