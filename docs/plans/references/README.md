...
| [`m8-draft010-p2-parent-validation-20260914.md`](m8-draft010-p2-parent-validation-20260914.md) | `draft-0.10` C: 专用 parent 复验结果 | `PARENT_CANDIDATE_VALIDATED / P2_NOT_YET_ISSUED`；NTFS、no-follow、relative walk、stream/ID/ACL 复验均通过；目录为空 |
