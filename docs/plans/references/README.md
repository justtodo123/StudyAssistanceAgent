...
| [`m8-active-execution-protocol-draft-0.11-authorization-20260914.md`](m8-active-execution-protocol-draft-0.11-authorization-20260914.md) | `draft-0.11` 协议修订授权记录 | `AUTHORIZED_FOR_PROTOCOL_REVISION / NOT_A_GATE / NOT_EXECUTION_AUTHORIZED`；owner 批准 A+B+C 一次性修订及六项边界；协议正文尚未创建 |
