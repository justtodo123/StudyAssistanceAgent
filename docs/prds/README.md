...
- M6b 与 M7 彼此不互为前置；各自的 Source/退出证据和保护基线必须独立留证，专属决策与批准也必须分别闭合。
  ...
  scope 为 `ADMITTED / IN_PROGRESS`，生产开工已授权且 M7-1 Source Registry 已落地，Network 不在 scope 内。
...
*创建：2026-08-24 · 更新：2026-08-31（同步 M7 `ADMITTED / IN_PROGRESS` 与 M7-1 状态）· 维护：新增/修订 PRD 时同步本表*