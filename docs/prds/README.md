...
- M8/M9/M10 的事实型 M7 退出前置已满足；M9 已于 2026-09-22 在 `m9-plan-lifecycle-v1` 范围内取得独立完成
  批准，现为 `ADMITTED / COMPLETE`。M8 仍因其他前置、强制决策和独立批准未闭合而保持
  `BLOCKED / NOT_STARTED`；M10 的三项前置亦已于 2026-09-22 全部 `SATISFIED`，但自身十一项强制决策与
  独立批准仍未闭合，故同样保持 `BLOCKED / NOT_STARTED`。Milvus 未选定或获批。
