...
### M3：工程质量与沉淀（M3a/M3b 已完成，M3c/M3d 待推进）
> **分支映射**：`feature/m3a-vector-store` → `feature/m3b-observability`
> **当前状态**：M3a 向量存储迁移与 M3b 可观测性已实现并完成阶段测试；M3c 因 `knowledge/interview/` 尚不存在而条件跳过 10 项测试。
...
*创建：2026-08-10 · 版本：v1.0（M3a/M3b 已完成：三课 35 篇条目、75 题评测集、根级测试 90 项、平台测试 40 项；M3c/M3d 待推进）· 维护：每次会话开工查看本文档*
