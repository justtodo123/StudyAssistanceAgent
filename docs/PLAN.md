...
- ✅ 数据结构复习：`knowledge/ds/`（绪论/线性表/栈队列/串数组广义表/树/图/查找/排序/真题复盘）9 篇完成（M1b 完成）
- ✅ 计算机组成原理：`knowledge/co/`（概述/数据表示/运算器/存储系统/指令系统/CPU设计/总线I/O/MIPS实验/期考复盘）9 篇完成（M1c 完成）
- ✅ 每课配 RAG 评测集：OS 33 题 + DS 20 题 + CO 16 题
...
*创建：2026-08-10 · 版本：v0.9（M1d 平台打磨完成：三课 35 篇条目、75 题评测集、Recall@3 均≥0.95、平台优化完成）· 维护：每次会话开工查看本文档*
