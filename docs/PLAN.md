...
> 状态图例：⬜ 未开始 ｜ 🔄 进行中 ｜ ✅ 完成
> **当前阶段**：M6a 已获准开工，当前为 `ADMITTED / IN_PROGRESS`（M6a-1 协议契约）；M6b–M10 仍为 `BLOCKED / NOT_STARTED`。里程碑、准入与退出方向以**本文**为准。
...
| --- | --- | --- | --- | --- |
| M6a | `ADMITTED` | `IN_PROGRESS` | [`m6a-harness-skeleton-plan.md`](plans/m6a-harness-skeleton-plan.md) | 八项强制决策与保护基线已闭合；justtodo123 于 2026-08-25 批准开工，M6a-1 协议契约实现进行中 |
...
- 🔄 **M6a Harness 兼容骨架**：M6a-1 正在完成契约收敛，后续再适配现有实现。
