...
> **「我给自己做了一个课程学习+面试备战系统：把大学计算机课程按『考点/面经/掌握度』建模成自己的知识库，搭了多路召回 RAG（本地 BGE 向量 + BM25 + RRF 融合）和 FastAPI 轻量 Agent，检索我自己的课程笔记来回答问题，回答带出处，还能生成复习计划。我用它通过了操作系统考试并准备求职面试。」**
