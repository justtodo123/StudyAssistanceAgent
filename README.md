...
**当前状态**：`v0.7 M1c 完成` — OS 15 篇 + DS 9 篇 + CO 9 篇完成，共 33 篇条目（branch: `feature/m1c-co-knowledge`）
...
| 课程笔记管理 | 结构化笔记、例题、错题集的创建与检索 | ✅ 已实现（OS 15 篇 + DS 9 篇 + CO 9 篇） |
| 多路召回 RAG | BM25 关键词 + BGE 向量 + RRF 融合检索，带出处标注 | ✅ 已实现 |
| RAG 评测 | OS 33 题 + DS 20 题 + CO 16 题评测集，Recall/Precision/F1 量化 | ✅ 已实现 |
