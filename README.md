...
**当前状态**：M6a-P0 crawler 已收口；M6a–M10 均为 `BLOCKED / NOT_STARTED`，只有设计/准备草案，未获准开工；M0–M5 MVP 可用。
...
| Harness 框架 | crawler P0 已收口；M6a–M10 均被准入门禁阻断，M6b 只读预览与 M10 自主 Runner 尚未实现 | ⬜ `BLOCKED / NOT_STARTED` |
