...
**当前状态**：`v0.3 M0 收尾` — FastAPI 后端就绪（多路召回 + 带出处问答 + SSE 流式），OS 知识库 6 篇已入库，各级 README 文档体系完善。
...
| 课程笔记管理 | 结构化笔记、例题、错题集的创建与检索 | ✅ 已实现（OS 6 篇） |
| 多路召回 RAG | BM25 关键词 + BGE 向量 + RRF 融合检索，带出处标注 | ✅ 已实现 |
| OS 真题评测 | 20 题 RAG 评测集，支持 Recall/Precision/F1/Latency 量化 | ✅ 已实现 |
