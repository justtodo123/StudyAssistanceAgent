...
**当前状态**：M6a-P0 crawler 已收口；八项决策、保护基线与负责人批准已闭合；M6a 为 `ADMITTED / NOT_STARTED`，M6b–M10 仍为 `BLOCKED / NOT_STARTED`；M0–M5 MVP 可用。
...
| Harness 框架 | M6a 兼容骨架已获准但尚未实施；M6b–M10 仍被准入门禁阻断，只读预览与自主 Runner 尚未实现 | ⬜ M6a `ADMITTED / NOT_STARTED` |
